...
class Glyphs
{
     ...
     * @return string
     */
    protected function getGlyphs(string $char, int $type): string
    {
     ...
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
    protected function preConvert(string $str): string
    {
        $crntChar = null;
        $prevChar = null;
        $nextChar = null;
     ...
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
    public function a4MaxChars(int $font): int
    {
     ...
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
    public function a4Lines(string $str, int $font): int
    {
        $str = str_replace(["\r\n", "\n", "\r"], "\n", $str);
     ...
     *
     * @param string $str Arabic string in Windows-1256 charset
     * @param int $max Max number of chars you can fit in one line
     ...
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
    public function utf8Glyphs(string $str, int $max = 1000): string
    {

        $max_chars = $this->config['max_chars'] ?? $max;
        $hindo = $this->config['hindu_numbers'] ?? true;
     ...
     * @return string
     */
    protected function decodeEntities(string $text, array $exclude = []): string
    {
        static $table;
